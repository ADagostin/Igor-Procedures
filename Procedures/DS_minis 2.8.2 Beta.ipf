...
Function Detect_Mini(Evt_Num, Sourcewave, mEPSC, Mini_size, V_Minloc)
	...
	Wave AVGs
	//duplicate/o No_die, EPSC_Template
	ControlINfo /W=Analysis_minis Positive
	Variable Absolute=V_Value
	If (Absolute==0)
...
//	setdatafolder $Host_DAtafolder
	if (WinType(panelName) == 7)
		...
		If (Stringmatch(CtrlName, "Existing")==1)	
			//renamewindow WaveSelector Choose_Analysis_Datafolder
			//panelName="Choose_Analysis_Datafolder"
...
//	SetVariable setdecaylow,pos={22,370},size={140,16},title="Rise Tau [s]   ",fSize=10,limits={-inf,inf,0.00001},value=root:G_Rise_Tau, Disable=1, proc=Set_Value
	SetVariable setdecayhigh,pos={22,380},size={140,16},title="Decay Tau [s]",fSize=12,limits={-inf,inf,0.00001},value= root:G_Decay_Tau, Disable=1, proc=Set_Value
	...
	Button Reset_x,Win=Analysis_Minis, pos={420,470},size={25,25},fColor=(65280,21760,0),Title="\Z16\f01Æ", proc=Axis_Range, Disable=0
	...
	Button Reset_y,Win=Analysis_Minis, pos={315,365},size={25,25},fColor=(65280,21760,0),Title="\Z16\f01Æ", proc=Axis_Range, Disable=0	
	Button Reset_ALL,Win=Analysis_Minis, pos={315,470},size={25,25},fColor=(52224,0,0),Title="\Z16\f01Æ", proc=Axis_Range, Disable=0
...
if (abs(a_decaytime[i])>0.010 || numtype(a_decaytime[i])==2 || a_decaytime[i]<0 || ABS(a_amplitude[i])<ABS(G_Threshold))
